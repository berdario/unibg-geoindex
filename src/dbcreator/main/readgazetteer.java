...
public class readgazetteer {
	...
	public void carica(String path) throws IOException {
			...
			if(parola[7].equalsIgnoreCase("ADM1") || parola[7].equalsIgnoreCase("ADM2") || parola[7].equalsIgnoreCase("ADM3") || parola[7].equalsIgnoreCase("ADM4"))
			{
				...
				if(mbr==null){
					...
					if(mbr==null)
						...
						// QUINDI LA RICERCA RITORNA NOMI DI PI� PAESI CHE INTERSECANO CON IL CENTROIDE
						...
						// DI QUESTI PAESI PRENDO QUELLO CHE HA "ASSOMIGLIA" DI PI� AL NOME DEL PAESE 
						// MA SOLO SE QUESTA PROBABILIT� � PI� ALTA DEL 70%
						if(prescelto>0.70){
							ritrovati++;
				...
				// SE IL PAESE � STATO TROVATO VERIFICO CHE IL SUO CENTROIDE 
				...
				// ORA AGGIUNGO AL NUOVO GAZETTEER ALTRE INFORMAZIONI COME (� NAZIONE? , � UNA REGIONE? , � COMPOSTA DA PI� PAROLE? )
		...
		file_log.write("\r\n---------------------------------------------------------------\r\n");
		file_log.write("Paesi trovati ma non confermati (il centroide � al di fuori del bounding box)\r\n\r\n");
